...
To enable it just use *activateLeakHunter = true* in `@DBUnit`annotation, example:
...
----
<1> If number of connections after test execution are grater than before then a *LeakHunterException* will be raised.
