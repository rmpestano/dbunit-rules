...
----
<1> You will need a runner that enables CDI during test execution, in case https://deltaspike.apache.org/documentation/test-control.html[DeltaSpike test control^].
