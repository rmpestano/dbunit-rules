...
[source,java]
----
include::https://github.com/rmpestano/dbunit-rules/blob/master/examples/src/test/java/com/github/dbunit/rules/examples/cucumber/ContactFeature.java[]
----
...
[source,java]
----
include::blob/master/examples/src/test/java/com/github/dbunit/rules/examples/cucumber/ContactSteps.java[]
----
