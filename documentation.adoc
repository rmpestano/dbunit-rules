...
|[green]#*passed*#
12+^|*Totals*
|10|0|10|36|0|0|0|0|0|36 2+|05s 395ms
|===
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(05s 341ms)#
******
...
Given ::
=====
The following feature icon:thumbs-up[role="green",title="Passed"] [small right]#(028ms)#
******
...
Then ::
=====
Test must fail with following error: icon:thumbs-up[role="green",title="Passed"] [small right]#(012ms)#
******
