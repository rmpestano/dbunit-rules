...
|[green]#*passed*#
12+^|*Totals*
|11|0|11|39|0|0|0|0|0|39 2+|01s 190ms
|===
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 172ms)#
******
...
Given ::
=====
The following feature icon:thumbs-up[role="green",title="Passed"] [small right]#(016ms)#
******
