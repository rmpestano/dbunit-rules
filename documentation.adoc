...
|[red]#*failed*#
12+^|*Totals*
|8|1|9|32|1|0|0|0|0|33 2+|07s 412ms
|===
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(06s 666ms)#
******
...
And ::
=====
The following dataset icon:thumbs-up[role="green",title="Passed"] [small right]#(015ms)#
******
...
Given ::
=====
Groovy script engine is on test classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(013ms)#
******
...
Then ::
=====
Test must fail showing what it was expecting as database state. icon:thumbs-down[role="red",title="Failed"] [small right]#(704ms)#
******
