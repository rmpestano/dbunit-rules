...
|[red]#*failed*#
12+^|*Totals*
|8|1|9|32|1|0|0|0|0|33 2+|06s 365ms
|===
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(03s 990ms)#
******
...
Then ::
=====
Test must pass because database state is as in expected dataset. icon:thumbs-up[role="green",title="Passed"] [small right]#(005ms)#
=====
****
...
Then ::
=====
Test must pass because database state is as in expected dataset. icon:thumbs-up[role="green",title="Passed"] [small right]#(009ms)#
=====
****
...
Then ::
=====
Test must fail showing what it was expecting as database state. icon:thumbs-down[role="red",title="Failed"] [small right]#(02s 347ms)#
******
