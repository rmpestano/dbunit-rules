...
|[green]#*passed*#
12+^|*Totals*
|11|0|11|39|0|0|0|0|0|39 2+|05s 369ms
|===
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(05s 314ms)#
******
...
Given ::
=====
Groovy script engine is on test classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(001ms)#
******
...
Then ::
=====
Dataset script should be interpreted while seeding the database icon:thumbs-up[role="green",title="Passed"] [small right]#(010ms)#
=====
****
...
Then ::
=====
Test must pass because database state is as in expected dataset. icon:thumbs-up[role="green",title="Passed"] [small right]#(018ms)#
=====
****
...
Given ::
=====
The following dataset icon:thumbs-up[role="green",title="Passed"] [small right]#(008ms)#
******
