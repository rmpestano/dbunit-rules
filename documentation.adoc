...
|[green]#*passed*#
12+^|*Totals*
|10|0|10|36|0|0|0|0|0|36 2+|05s 582ms
|===
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(05s 535ms)#
******
...
Given ::
=====
Groovy script engine is on test classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(016ms)#
******
