...
|[green]#*passed*#
12+^|*Totals*
|11|0|11|39|0|0|0|0|0|39 2+|05s 349ms
|===
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(05s 308ms)#
******
...
TIP: Source code of the above example can be https://github.com/rmpestano/dbunit-rules/blob/master/cdi/src/test/java/com/github/dbunit/rules/DBUnitCDIIt.javaL74[found here^].
...
TIP: Source code for the example above can be https://github.com/rmpestano/dbunit-rules/blob/master/examples/jpa-productivity-boosters/src/test/java/com/github/dbunit/rules/examples/cucumber/ContactSteps.javaL16[found here^].
...
Given ::
=====
Groovy script engine is on test classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(008ms)#
******
...
Given ::
=====
The following dataset icon:thumbs-up[role="green",title="Passed"] [small right]#(011ms)#
******
...
Then ::
=====
Test must pass because database state is as in expected dataset. icon:thumbs-up[role="green",title="Passed"] [small right]#(002ms)#
=====
****
...
Then ::
=====
Test must fail with following error: icon:thumbs-up[role="green",title="Passed"] [small right]#(003ms)#
******
