...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(495ms)#
******
...
When ::
=====
The following test is executed: icon:thumbs-up[role="green",title="Passed"] [small right]#(009ms)#
******
