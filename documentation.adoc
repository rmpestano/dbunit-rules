...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(729ms)#
******
...
Given ::
=====
The following feature icon:thumbs-up[role="green",title="Passed"] [small right]#(003ms)#
******
