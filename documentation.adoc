...
|[green]#*passed*#
12+^|*Totals*
|9|0|9|33|0|0|0|0|0|33 2+|04s 385ms
|===
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(04s 351ms)#
******
...
Given ::
=====
The following dataset icon:thumbs-up[role="green",title="Passed"] [small right]#(019ms)#
******
