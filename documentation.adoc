...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(326ms)#
******
...
Then ::
=====
The database should be seeded with the dataset content icon:thumbs-up[role="green",title="Passed"] [small right]#(170ms)#
=====
****
