...
|[green]#*passed*#
12+^|*Totals*
|11|0|11|39|0|0|0|0|0|39 2+|01s 166ms
|===
...
And ::
=====
The following dataset icon:thumbs-up[role="green",title="Passed"] [small right]#(022ms)#
******
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 138ms)#
******
...
When ::
=====
The following junit5 test is executed icon:thumbs-up[role="green",title="Passed"] [small right]#(001ms)#
******
