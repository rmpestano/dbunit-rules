...
|[green]#*passed*#
12+^|*Totals*
|10|0|10|36|0|0|0|0|0|36 2+|04s 330ms
|===
...
Given ::
=====
Groovy script engine is on test classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(011ms)#
******
...
Then ::
=====
Test must fail with following error: icon:thumbs-up[role="green",title="Passed"] [small right]#(011ms)#
******
