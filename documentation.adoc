...
|[green]#*passed*#
12+^|*Totals*
|11|0|11|39|0|0|0|0|0|39 2+|01s 219ms
|===
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 212ms)#
******
...
When ::
=====
The following cucumber steps are executed icon:thumbs-up[role="green",title="Passed"] [small right]#(001ms)#
******
