...
|[green]#*passed*#
12+^|*Totals*
|10|0|10|36|0|0|0|0|0|36 2+|04s 036ms
|===
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(04s 008ms)#
******
...
Then ::
=====
Test must fail with following error: icon:thumbs-up[role="green",title="Passed"] [small right]#(014ms)#
******
