...
|[green]#*passed*#
12+^|*Totals*
|11|0|11|39|0|0|0|0|0|39 2+|05s 783ms
|===
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(05s 712ms)#
******
...
When ::
=====
The following junit5 test is executed icon:thumbs-up[role="green",title="Passed"] [small right]#(008ms)#
******
...
Given ::
=====
Groovy script engine is on test classpath icon:thumbs-up[role="green",title="Passed"] [small right]#(030ms)#
******
