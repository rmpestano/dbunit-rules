...
|[green]#*passed*#
12+^|*Totals*
|11|0|11|39|0|0|0|0|0|39 2+|961ms
|===
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(869ms)#
******
...
And ::
=====
The following dataset icon:thumbs-up[role="green",title="Passed"] [small right]#(089ms)#
******
