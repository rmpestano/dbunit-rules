...
|[green]#*passed*#
12+^|*Totals*
|10|0|10|36|0|0|0|0|0|36 2+|05s 998ms
|===
...
Given ::
=====
The following junit rules icon:thumbs-up[role="green",title="Passed"] [small right]#(006ms)#
******
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(05s 958ms)#
******
