...
|[green]#*passed*#
12+^|*Totals*
|11|0|11|39|0|0|0|0|0|39 2+|01s 137ms
|===
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(01s 128ms)#
******
...
When ::
=====
The following junit5 test is executed icon:thumbs-up[role="green",title="Passed"] [small right]#(006ms)#
******
