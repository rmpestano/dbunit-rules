...
|[green]#*passed*#
12+^|*Totals*
|11|0|11|39|0|0|0|0|0|39 2+|06s 376ms
|===
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(06s 335ms)#
******
...
When ::
=====
The following junit5 test is executed icon:thumbs-up[role="green",title="Passed"] [small right]#(002ms)#
******
...
Then ::
=====
Test must pass because database state is as in expected dataset. icon:thumbs-up[role="green",title="Passed"] [small right]#(022ms)#
=====
****
