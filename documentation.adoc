...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(506ms)#
******
...
Then ::
=====
The database should be seeded with the dataset content before test execution icon:thumbs-up[role="green",title="Passed"] [small right]#(325ms)#
=====
****
...
Given ::
=====
The following junit rules icon:thumbs-up[role="green",title="Passed"] [small right]#(015ms)#
******
