...
Given ::
=====
The following junit rules icon:thumbs-up[role="green",title="Passed"] [small right]#(049ms)#
******
...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(502ms)#
******
...
And ::
=====
The following dataset icon:thumbs-up[role="green",title="Passed"] [small right]#(001ms)#
******
...
==== Scenario: Seed database with groovy script in dataset icon:thumbs-down[role="red",title="Failed"]

****
Given ::
=====
Groovy script engine is on test classpath icon:thumbs-down[role="yellow",title="Undefined"] [small right]#(000ms)#
******
...
And ::
=====
The following dataset icon:thumbs-down[role="purple",title="Skipped"] [small right]#(000ms)#
******
...
When ::
=====
The following test is executed: icon:thumbs-down[role="purple",title="Skipped"] [small right]#(000ms)#
******
...
Then ::
=====
Dataset script should be interpreted while seeding the database icon:thumbs-down[role="yellow",title="Undefined"] [small right]#(000ms)#
=====
****

==== Scenario: Seed database with javascript in dataset icon:thumbs-down[role="red",title="Failed"]
...
==== Scenario: Database assertion with yml dataset icon:thumbs-down[role="red",title="Failed"]
...
Then ::
=====
Test must pass because database state is as in expected dataset. icon:thumbs-down[role="yellow",title="Undefined"] [small right]#(000ms)#
=====
****

==== Scenario: Database assertion with regular expression in expected dataset icon:thumbs-down[role="red",title="Failed"]
...
==== Scenario: Database assertion with seeding before test execution icon:thumbs-down[role="red",title="Failed"]
...
==== Scenario: Failling database assertion icon:thumbs-down[role="red",title="Failed"]
...
Then ::
=====
Test must fail showing what it was expecting as database state. icon:thumbs-down[role="yellow",title="Undefined"] [small right]#(000ms)#
******
