...
IMPORTANT: Note that since version 0.4.1 this module was refactored and  now it is an independent module (does not depend on *core* neither *jpa* module anymore).
