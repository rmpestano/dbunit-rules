...
See full https://github.com/rmpestano/dbunit-rules/blob/master/examples/src/test/java/com/github/dbunit/rules/examples/DeltaspikeUsingInterceptorIt.java#L25[example here].
